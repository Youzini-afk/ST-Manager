...
- 已整理从 `8c258ec` 到 `9e6a4cd` 的面向用户更新说明：[`docs/changelog-8c258ec-to-latest.md`](docs/changelog-8c258ec-to-latest.md)
- 本轮重点包括：角色卡网格重构、详情页资源/管理区整理、聊天记录管理工作台、聊天阅读器与解析规则系统、SillyTavern 聊天同步支持
...
| **沉浸式阅读** | 全屏三栏阅读器，支持楼层导航、全文搜索、收藏楼层 |
| **本地元数据** | 支持显示名称、备注、最近阅读楼层、收藏状态等本地索引信息 |
| **楼层编辑** | 支持单层消息编辑、批量查找替换并写回原始聊天文件 |
| **解析规则** | 支持内置 / 本地 / 角色卡 / 聊天专属规则链，兼容 ST Regex / 预设导入 |
