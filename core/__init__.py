...
# === API 蓝图 ===
from core.api.v1 import cards, world_info, system, resources, automation, extensions, presets, st_sync, chats, beautify, remote_backups
...
def create_app():
    ...
    app.register_blueprint(remote_backups.bp)  # 远程 ST 备份/恢复
